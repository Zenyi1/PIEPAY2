  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            ...
            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex-shrink-0 flex items-center">
                      <h4 className='font-mono text-xl text-greay font-bold hidden lg:block'>PIE PAY</h4>
                </div>
        ...
        <div className={`sm:hidden ${!openMenu?"hidden":""}`} id="mobile-menu">
            ...
            <a href="#" className="text-greay hover:bg-[#F7C984] hover:text-greay block px-3 py-2 rounded-md text-base font-medium">Pies</a>
