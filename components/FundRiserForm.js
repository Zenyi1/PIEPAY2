...
const FundRiserForm = () => {
  ...
  return (
    <>
        <h1 className="font-sans font-bold text-xl">Create a pie with your friends 🤝</h1>
        <form onSubmit={(e)=>riseFund(e)}>
            ...
            <div className="form-control my-1">
                <label className="text-sm text-gray-700">Total Pie Value :</label>
            ...
            <div className="form-control my-1">
                <label className="text-sm text-gray-700">Minimum price for a slice :</label>
            ...
            <div className="form-control date-picker my-1">
                <label className="text-sm text-gray-700">Best by  :</label>
